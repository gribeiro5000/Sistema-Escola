...
{
    public partial class Cadastro_Atendimento : Form
    {
        Usuário _usuario = new Usuário();
        Conexão c = new Conexão();
        public Cadastro_Atendimento()
        {
            InitializeComponent();
        }
        ...
        private void bt_cadastrar_Click(object sender, EventArgs e)
        {
            ...
            if (c.confirmar_usuario(_usuario.Usuario, _usuario.Cargo) == true)
            {
                ...
                Login_Atendimento loginatendimento = new Login_Atendimento();
